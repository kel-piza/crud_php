                ...
                <div class="card-body">
                    <form class="form-horizontal" action="create.php" method="post">
                        ...
                        <div class="control group <?php echo !empty($nomeErro) ? 'error' : ''; ?>">
                            ...
                            <div class="controls">
                                <input size="50" class="form-control" name="nome" type="text" placeholder="None"
                        ...
                        <div class="control group <?php echo !empty($telefoneErro) ? 'error' : ''; ?>">
                            ...
                            <div class="controls">
                                ...
                                <?php if (!empty($telefoncErro)): ?>
                                    <span class="text-danger"><?php echo $telefoneErro; ?></span>
                                <?php endif; ?>
                            </div>
                        </div>

                        <div class="control group <?php !empty($emailErro)? 'ŞemailErro' : ''; ?>">
...
<script src="https://code.jquery.com/jquery-3.3.1.js" integrity="sha256-2Kok7MbOyxpgUVvAk/HJ2j1gOSYS2auK4Pfzbm7uH60="
    crossorigin="anonymous"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/und/popper.min.js"
    integrity="sha384-ZMP7rVo3mIykV+2+9J3U346jBkBWL.aUAdn689aCwoqbBJiSnjAK/18WvCWPIPm49" 
    crossorigin="anonymous"></script>
